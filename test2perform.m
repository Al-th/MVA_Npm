...
dMax_bunny = [0.05:0.03:0.2, 0.3:0.1:1];
iterMax = [150 50];
...
for i = 2:size(dMax_bunny,2)
    ...
    save(['./Test/info_dmax_bunny_sicp' int2str(i) '.mat'],'info_sicp');
    ...
    save(['./Test/info_dmax_bunny_gicp' int2str(i) '.mat'],'info_gicp');
...
save('./Test/info_dmax_hannover_sicp.mat','info_sicp');
save('./Test/info_dmax_hannover_gicp.mat','info_gicp');
