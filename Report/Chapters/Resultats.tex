...
En général, le choix de $d_{max}$ est un compromis entre la précision de l'algorithme et sa portée de convergence. En effet, une valeur faible de $d_{max}$ entraîne un faîble nombre de points appariés rendant la convergence de l'algorithme plus difficile. Au contraîre, une valeur plus élevée
