function [A_trans, transformation, transformation_evolution, size_subset] = minimization(A,covA,B,covB,groundTruthTransformation,initTransform,iterMax,dMax,useGenICP)
